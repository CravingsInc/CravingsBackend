...
<head>
 ...
 .pc-w620-lineHeight-175pc {line-height: 175% !important;}
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                  <td align="center" valign="top" style="padding: 0px 0px 20px 0px;">
                   <img src="hhttps://cravings-media.nyc3.cdn.digitaloceanspaces.com/company-folder/logo.png" class="" width="125" height="43" alt="" style="display: block; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width:125px; height: auto; max-width: 100%; border: 0;" />
                  </td>
                 </tr>
                </table>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                  <td align="center" valign="top" style="padding: 0px 0px 21px 0px;">
                   <img src="https://cravings-media.nyc3.cdn.digitaloceanspaces.com/company-folder/waitlist-banner.png" class="" width="520" height="265" alt="" style="display: block; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width:520px; height: auto; max-width: 100%; border-radius: 8px; border: 0;" />
                  </td>
                 </tr>
                </table>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <tr>
                     <td valign="top" align="center">
                      <div class="pc-font-alt" style="line-height: 121%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 500; font-variant-ligatures: normal; color: #40be65; text-align: center; text-align-last: center;">
                       <div><span>Welcome To The Waitlist</span>
                       </div>
                      </div>
                     </td>
                    </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                 <tr>
                  <td valign="top" align="center" style="padding: 0px 0px 10px 0px;">
                   <div class="pc-font-alt pc-w620-fontSize-30 pc-w620-lineHeight-133pc" style="line-height: 128%; letter-spacing: -0.6px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 36px; font-weight: 800; font-variant-ligatures: normal; color: #1b1b1b; text-align: center; text-align-last: center;">
                    <div><span>Dear {{orgName}}</span>
                    </div>
                   </div>
                  </td>
                 </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                 <tr>
                  <td valign="top" align="center" style="padding: 0px 0px 30px 0px;">
                   <div class="pc-font-alt pc-w620-fontSize-16 pc-w620-lineHeight-175pc" style="line-height: 156%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 18px; font-weight: 300; font-variant-ligatures: normal; color: #9b9b9b; text-align: center; text-align-last: center;">
                    <div><span>We are excited to have you onboard and you&#39;ll be the first to know when our platform is ready for organizers like you to start planning and hosting events effortlessly.</span>
                    </div>
                   </div>
                  </td>
                 </tr>
